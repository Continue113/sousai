 ...
 <body class="background"> 
  ...
  <div class="container">
    ...
    <div class="row">
     ...
     <div class="span1 backgroundMenu "> 
      <ul class="nav nav-stacked nav-side">
       <li><h5><a href="#"><i class="icon-plus icon-white"></i>系统发布:</a></h5></li>
       ...
       <li><h5><a href="#"><i class="icon-plus icon-white"></i>数据维护:</a></h5></li>
       ...
       <li><h5><a href="#"><i class="icon-plus icon-white"></i>网站统计</a></h5></li>
     ...
     <div class="span9">
         ...
         <div class="jplist-panel jplist-panel-top"> 
          <div class="jplist-drop-down" data-control-type="drop-down" data-control-name="sort" data-control-action="sort" data-datetime-format="{year}-{month}-{day}"> 
           <ul> 
            ...
            <li><span data-path=".match-address" data-order="asc" data-type="text">比赛地点</span><i class="icon-arrow-up"></i></li> 
         ...
         <thead><th>比赛名称</th><th>比赛时间</th><th>比赛场地</th><th>网站来源</th></thead>
         <tbody>
         <tr class="match">
         ...
         <td class="match-address">四川省成都市武侯区人民体育馆乒乓球馆</td>
         <td class="match-from"><a href="#">http://www.baidu.com</a><a href="#" class="btn btn-mini pull-right">查看编辑</a></td>
         </tr>
         <tr class="match">
         ...
         <td class="match-address">wu四川省成都市武侯区人民体育馆乒乓球馆四川省民体育馆乒乓球馆四川省</td>
         <td class="match-from"><a href="#">http://www.baidu1.com四川省成都市民体育馆乒乓球馆四川省</a><a href="#" class="btn btn-mini pull-right">查看编辑</a></td>
         </tr>
         </tbody>
         </table>
