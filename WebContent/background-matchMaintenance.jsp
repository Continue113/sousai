...
<!-- /background-remind & backgroundMenu --> 
     <div class="span9">
         ...
         <div class="jplist-panel jplist-panel-top"> 
          <div class="jplist-drop-down" data-control-type="drop-down" data-control-name="sort" data-control-action="sort" data-datetime-format="{year}-{month}-{day}"> 
           <ul> 
            ...
            <li><span data-path=".match-court" data-order="asc" data-type="text">比赛场地</span><i class="icon-arrow-up"></i></li>
            <li><span data-path=".match-releaseTime" data-order="asc" data-type="datetime">发布时间</span><i class="icon-arrow-up"></i></li>
            <li><span data-path=".match-releaseUser" data-order="asc" data-type="text">发布用户</span><i class="icon-arrow-up"></i></li> 
           </ul>
          </div>
          ...
          <div class="text-filter-box input-append"> 
           ...
           <select class="selectFilter">
            ...
            <option data-forFilter=".match-court">比赛场地</option>
            <option data-forFilter=".match-releaseTime">发布时间</option>
            <option data-forFilter=".match-releaseUser">发布用户</option>
           </select>
         ...
         <thead><th>比赛名称</th><th>比赛时间</th><th class="th-matchCourt">比赛场地</th><th>发布时间</th><th>发布用户</th></thead>
         <tbody>
         <tr class="match">
         ...
         <td class="match-court">四川省成都市武侯区人民体育馆乒乓球馆</td>
         <td class="match-releaseTime">2014-9-14</td>
         <td class="match-releaseUser">搜赛网</td>
         <td class="match-oprate"><a href="#" class="btn btn-mini pull-right">查看编辑</a></td>
         </tr>
         </tbody>
         </table>
