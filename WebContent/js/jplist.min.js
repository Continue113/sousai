...
(function() {
	jQuery.fn.jplist.app.dto.StatusDTO = function(b, f, c, a, e, d, g) {
		this.action = f;
		this.name = b;
		this.type = c;
		this.data = a;
	...
	jQuery.fn.jplist.domain.dom.services.FiltersService.dateRangeFilter = function(b, f, c, a, e, d, g, k, l) {
		for (var h = [], m, n, q, p, r = 0; r < f.length; r++)
			if (m = f[r], n = m.findPathitem(b))
				if (q = !jQuery.isNumeric(a) || !jQuery.isNumeric(e) || !jQuery.isNumeric(d), p = !jQuery.isNumeric(g) || !jQuery.isNumeric(k) || !jQuery.isNumeric(l), q || p) h.push(m);
				else
		if ((p = jQuery.fn.jplist.domain.dom.services.HelperService.formatDateTime(n.text, c)) && jQuery.isFunction(p.getFullYear)) n = new Date(a, e, d), q = new Date(g, k, l), p.setHours(0),
...
(function() {
	jQuery.fn.jplist.domain.dom.services.FiltersService.textFilterPathGroup = function(b, f, c) {
		...
		for (a = 0; a < c.length; a++) {
			...
			if (e = b.findPathitem(e)) e = jQuery.fn.jplist.domain.dom.services.HelperService.removeCharacters(e.text,
...
(function() {
	...
	jQuery.fn.jplist.animation.drawItems = function(b, f, c, a, e, d, g) {
		var k, l, h;
		if (a = jQuery.fn.jplist.animation[a]) {
			k = a.before;
			h = a.effect;
			l = a.after;
			jQuery.isFunction(k) && k(b, f, c);
			if (jQuery.isFunction(h)) g.on(g.events.animationStepEvent, function(a, e, d) {
				h(b, f, c, e)
			});
			g.on(g.events.animationCompleteEvent, function(a) {
				jQuery.isFunction(l) && l(b, f, c);
				g.off(g.events.animationStepEvent);
				g.off(g.events.animationCompleteEvent);
				jQuery.isFunction(d) && d()
			});
			e.play(b.duration)
		} else jQuery.isFunction(d) &&
			d()
	}
})();
(function() {
...
(function() {
	...
	jQuery.fn.jplist.animation.fade.before = function(b, f, c) {};
	jQuery.fn.jplist.animation.fade.effect = function(b, f, c, a) {
		f.find(b.itemPath).css({
			opacity: (100 - a) / 100
		})
	};
	jQuery.fn.jplist.animation.fade.after = function(b, f, c) {
		f.html("");
		c.css({
			opacity: 1
		});
	...
	var b = function(a, d, g, b) {
		...
		jQuery.isFunction(a.options.redrawCallback) && a.options.redrawCallback(d, b, g)
			...
			0 >= c.length || 0 >= f.length ? (a.$noResults.removeClass("jplist-hidden"), a.$itemsBox.addClass("jplist-hidden"), b(a, d, g, f)) : (a.$noResults.addClass("jplist-hidden"), a.$itemsBox.removeClass("jplist-hidden"),
				a.options.effect ? (a.history && (c = a.history.getLastStatus()) && !c.inAnimation && (h = !0), h = h ? m : a.options, jQuery.fn.jplist.animation.drawItems(h, a.$itemsBox, f, a.options.effect, a.timeline, function() {
					b(a, d, g, f)
	...
	var b = function(b) {
		b.observer.on(b.observer.events.renderList, function(a, e, d) {
			...
			jQuery.fn.jplist.dal.services.URIService.get(d, b.options, function(a, e) {
				var d = new jQuery.fn.jplist.domain.serverHTML.models.DataItemModel(a),
					f, m;
...
(function() {
	var b = function(a, d, g) {
		...
		jQuery.isFunction(a.options.redrawCallback) && a.options.redrawCallback(d, g)
			...
			a.options.effect ? (a.history && (f = a.history.getLastStatus()) && !f.inAnimation && (c = !0), c = c ? h : a.options, jQuery.fn.jplist.animation.drawItems(c, a.$itemsBox, jQuery(d), a.options.effect, a.timeline, function() {
				b(a, d, g)
			...
			a.scopeObserver.on(a.scopeObserver.events.modelChanged, function(d, g, b) {
				a.$preloader &&
					a.$preloader.addClass("jplist-hidden");
	...
	jQuery.fn.jplist.ui.list.views.ServerHTMLView = function(e, d, g, b, c, f) {
		return new a(e,
			d, g, b, c, f)
	}
})();
		...
		isNaN(b) || (e > b ? a.addClass("jplist-sticky") : a.removeClass("jplist-sticky"))
			...
			a.observer.on(a.observer.events.changeUrlDeepLinksEvent, function(e) {
				...
				if (a.options.deepLinking) {
					...
					var b;
					e = "" === e ? "#" : "#" + e;
					window.location.hash !== e && ("replaceState" in window.history ? window.history.replaceState("", "", e) : (b = window.location.href.indexOf("#"), e = -1 == b ? window.location.href + e : window.location.href.substring(0, b) + e, window.location.replace(e)))
				}
			});
			a.observer.on(a.observer.events.setDeepLinksEvent, function(e) {
				var b = jQuery.trim(window.location.hash.replace("#", ""));
				e = [];
				var c, f = [],
					m;
				if (a.options.deepLinking && "" !== jQuery.trim(b)) {
					e = b.split(a.options.delimiter1);
					for (b = 0; b < e.length; b++) c = e[b], m = c.split("="), 2 === m.length && (c = m[0], m = m[1], c = c.split(a.options.delimiter0), 2 === c.length && (c = {
						controlName: c[0],
						propName: c[1],
						propValue: m
					}, f.push(c)))
				}
				jQuery.fn.jplist.info(a.options, "Set deep link event: ", f);
				0 >= f.length ? a.observer.trigger(a.observer.events.forceRenderStatusesEvent, [!0]) : a.controls.setDeepLinks(f)
			});
...
(function() {
	...
	b.prototype.create = function(b) {
		...
		k = !1;
		h = l = null;
		(e = b.attr("data-control-storage")) && "false" === e.toString() && (d = !1);
		(e = b.attr("data-control-animation")) && "false" === e.toString() && (g = !1);
		(e = b.attr("data-control-animate-to-top")) && "true" === e.toString() && (k = !0);
		if (e = this.options.controlTypes[a]) e.className && (l = jQuery.fn.jplist.ui.controls[e.className]),
		e.options && (h = e.options);
		a = {
			type: a,
	...
	jQuery.fn.jplist.ui.panel.ControlFactory = function(f, c, a, e) {
		return new b(f, c, a,
			e)
	}
})();
(function() {
	var b = jQuery.fn.jplist.domain,
		f = function(a, d) {
			...
			for (var b = [], c, f, h, m = 0; m < a.controls.length; m++)
				if (c = a.controls[m], jQuery.isFunction(c.getStatus) && (c = c.getStatus(d))) {
					f = -1;
					h = void 0;
			...
			f.controlFactory = new jQuery.fn.jplist.ui.panel.ControlFactory(a, d, b, c);
			for (a = 0; a < f.$controls.length; a++) b = f.$controls.eq(a), d = f, (b = d.controlFactory.create(b)) && d.controls.push(b);
	...
	a.prototype.setDeepLinks = function(a) {
		...
		for (h = 0; h < a.length; h++) {
			...
			b = m;
			for (m = 0; m < b.length; m++) k = b[m], jQuery.isFunction(k.getStatusByDeepLink) && (k = k.getStatusByDeepLink(d.propName, d.propValue)) && l.push(k)
		}
		a = c(this, !1);
...
(function() {
	var b = function(a, d) {
		...
		if (d && c) b = c;
			...
			case "paging":
				...
				b = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, b, a.inStorage, a.inAnimation, a.isAnimateToTop);
				break;
			case "sort":
				(b = a.$control.attr("data-datetime-format")) ||
					(b = "");
				...
				break;
			case "filter":
				b = new jQuery.fn.jplist.ui.controls.DropdownFilterDTO(c.attr("data-path"), c.attr("data-type")), b = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, b, a.inStorage, a.inAnimation, a.isAnimateToTop)
		}
		return b
	},
		f = function(a, d) {
			...
			jQuery(document).off("jplist_dropdown_close").on("jplist_dropdown_close", function(a, e) {
				d.each(function() {
			...
			a.$control.find("li").off().click(function() {
				...
				c ? (d.data.path = c, d.data.type = h.attr("data-type"), d.data.order = h.attr("data-order")) : f && (d.data.number = f);
	...
	a.prototype.getDeepLink = function() {
		var a = "",
			d;
		d = b(this, !1);
		if (d.data) switch (this.action) {
			case "paging":
				if (jQuery.isNumeric(d.data.number) || "all" === d.data.number) a =
					this.name + this.options.delimiter0 + "number=" + d.data.number;
				break;
			case "sort":
	...
	a.prototype.getStatusByDeepLink = function(a, d) {
		var g;
		var c;
		if ("number" !== a && a !== "path" + this.options.delimiter2 +
			"type" + this.options.delimiter2 + "order" && "path" !== a) g = null;
		else if (g = b(this, !0), g.data) switch (this.action) {
			case "paging":
				"number" === a && jQuery.isNumeric(g.data.number) && (g.data.number = d);
				break;
			case "sort":
				a === "path" + this.options.delimiter2 + "type" + this.options.delimiter2 + "order" && (c = d.split(this.options.delimiter2), 3 === c.length && (g.data.path = c[0], g.data.type = c[1], g.data.order = c[2]));
				break;
			case "filter":
	...
	a.prototype.setStatus =
		function(a, d) {
			...
			switch (this.action) {
				case "filter":
					!this.inStorage && d && 0 < b.length ? (a.data.path = b.attr("data-path"), a.data.type = b.attr("data-type"), this.history.addStatus(a), this.observer.trigger(this.observer.events.statusEvent, [a])) : (this.$control.find("li").removeClass("active"),
						b = this.$control.find('li:has([data-path="' + a.data.path + '"])'), b.addClass("active"), this.$control.find(".jplist-dd-panel").text(b.eq(0).text()));
					break;
				case "sort":
					!this.inStorage && d && 0 < b.length ? (a.data.path = b.attr("data-path"), a.data.type = b.attr("data-type"), a.data.order = b.attr("data-order"), this.history.addStatus(a), this.observer.trigger(this.observer.events.statusEvent, [a])) : (this.$control.find("li").removeClass("active"), b = "default" == a.data.path ? this.$control.find('li:has([data-path="default"])') :
						this.$control.find('li:has([data-path="' + a.data.path + '"][data-type="' + a.data.type + '"][data-order="' + a.data.order + '"])'), b.addClass("active"), this.$control.find(".jplist-dd-panel").text(b.eq(0).text()));
					break;
				case "paging":
					!this.inStorage && d && 0 < b.length ? (a.data.number = b.attr("data-number"), this.history.addStatus(a), this.observer.trigger(this.observer.events.statusEvent, [a])) : (this.$control.find("li").removeClass("active"), b = this.$control.find('li:has([data-number="' + a.data.number + '"])'), 0 === b.length &&
						(b = this.$control.find('li:has([data-number="all"])')), b.addClass("active"), this.$control.find(".jplist-dd-panel").text(b.eq(0).text()))
			}
	};
...
(function() {
	var b = function(a, d) {
		...
		if (d && b) c = b;
			...
			case "paging":
				...
				c = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, c, a.inStorage, a.inAnimation, a.isAnimateToTop);
				break;
			case "sort":
				...
				break;
			case "filter":
				c = new jQuery.fn.jplist.ui.controls.DropdownFilterDTO(b.attr("data-path"), b.attr("data-type")), c = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, c, a.inStorage, a.inAnimation, a.isAnimateToTop)
		}
		return c
	},
		f = function(a, d) {
			...
			a.$control.find("option").each(function() {
				b = jQuery(this).attr("data-path");
				c = jQuery(this).attr("data-type");
				b && (f = new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(b, c), d.push(f))
			})
		}, c = function(a) {
			a.$control.change(function() {
				...
				f ? (d.data.path = f, d.data.type = jQuery(this).attr("data-type"), d.data.order = jQuery(this).attr("data-order")) : c && (d.data.number = c);
				a.history.addStatus(d);
				a.observer.trigger(a.observer.events.statusEvent, [d])
			})
		}, a = function(a) {
	...
	a.prototype.getDeepLink = function() {
		...
		if (d.data) switch (this.action) {
			case "paging":
				...
				break;
			case "sort":
				d.data.path && (d.data.type && d.data.order) && (a = this.name + this.options.delimiter0 + "path" + this.options.delimiter2 + "type" + this.options.delimiter2 +
					"order=" + d.data.path + this.options.delimiter2 + d.data.type + this.options.delimiter2 + d.data.order);
				break;
			case "filter":
				d.data.path && (a = this.name + this.options.delimiter0 + "path=" + d.data.path)
		}
	...
	a.prototype.getStatusByDeepLink = function(a, d) {
		var c, f;
		c = b(this, !0);
		if (c.data) switch (this.action) {
			case "paging":
				"number" === a && jQuery.isNumeric(c.data.number) && (c.data.number = d);
				break;
			case "sort":
				a === "path" + this.options.delimiter2 + "type" + this.options.delimiter2 + "order" && (f = d.split(this.options.delimiter2),
					3 === f.length && (c.data.path = f[0], c.data.type = f[1], c.data.order = f[2]));
				break;
			case "filter":
	...
	a.prototype.setStatus = function(a, d) {
		...
		switch (this.action) {
			case "filter":
				if (!this.inStorage && d) a.data.path = "default", this.history.addStatus(a), this.observer.trigger(this.observer.events.statusEvent, [a]);
				else if ((b = this.$control.find('option[data-path="' + a.data.path +
					'"]')) && 0 < b.length) b.get(0).selected = !0;
				break;
			case "sort":
				!this.inStorage && d ? (a.data.path = "default", this.history.addStatus(a), this.observer.trigger(this.observer.events.statusEvent, [a])) : (b = "default" == a.data.path ? this.$control.find('option[data-path="' + a.data.path + '"]') : this.$control.find('option[data-path="' + a.data.path + '"][data-type="' + a.data.type + '"][data-order="' + a.data.order + '"]'), 0 < b.length && (b.get(0).selected = !0));
				break;
			case "paging":
				b = this.$control.find('option[data-number="' + a.data.number +
					'"]'), 0 === b.length && (b = this.$control.find('option[data-number="all"]')), b.get(0).selected = !0
		}
	};
...
(function() {
	var b = function(a, b) {
		...
		if (!b || !d) {
			...
			if (c = "true" === a.$control.attr("jump-to-start") || a.controlOptions.jumpToStart)(c = a.history.getLastStatus()) && "pagination" !== c.type && (d = 0);
			c = Number(a.$control.attr("data-items-per-page")) || 0;
			d = new jQuery.fn.jplist.ui.controls.PaginationDTO(d, c);
			d = new jQuery.fn.jplist.app.dto.StatusDTO(a.name,
				a.action, a.type, d, a.inStorage, a.inAnimation, a.isAnimateToTop)
		}
		return d
	}, f = function(a) {
	...
	c.prototype.getDeepLink =
		function() {
			var a = "",
				e;
			e = b(this, !1);
			e.data && (jQuery.isNumeric(e.data.currentPage) && (a = this.name + this.options.delimiter0 + "currentPage=" + e.data.currentPage), jQuery.isNumeric(e.data.number) && (a = this.name + this.options.delimiter0 + "number=" + e.data.number));
			return a
	};
	c.prototype.getStatusByDeepLink = function(a, e) {
		var d;
		d = null;
		"currentPage" !== a ? d = null : (d = b(this, !0), d.data && "currentPage" === a && (d.data.currentPage = e));
		return d
	};
...
(function() {
	var b = function(a, b) {
		...
		d = "";
		c = a.$control.data("storage-status");
		b && c ? d = c : (c = a.$control.attr("data-path"), f = b ? "" : a.$control.val(), a.controlOptions && a.controlOptions.ignore && (d = a.controlOptions.ignore), d = new jQuery.fn.jplist.ui.controls.TextboxDTO(c, f, d), d = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, d, a.inStorage, a.inAnimation, a.isAnimateToTop));
		return d
	}, f = function(a) {
			var e = "keyup";
			if (a.params.$button && 0 < a.params.$button.length) a.params.$button.on("click", function(d) {
				d.preventDefault();
	...
	c.prototype.getDeepLink = function() {
		var a = "",
			e;
		e = b(this, !1);
		e.data && "" !== jQuery.trim(e.data.value) && (a = this.name + this.options.delimiter0 + "value=" + e.data.value);
		return a
	};
	c.prototype.getStatusByDeepLink = function(a, e) {
		var d;
		d = b(this, !0);
		d.data && "value" === a && (d.data.value = e);
		return d
	};
...
(function() {
	var b = function(a, b) {
		var d;
		d = !1;
		b && a.params.storageStatus ? d = a.params.storageStatus : (b ? "grid-view" === a.params.defaultGrid && (d = !0) : d = a.$root.hasClass("jplist-grid"), d = new jQuery.fn.jplist.ui.controls.ViewsDTO(d), d = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, d, a.inStorage, a.inAnimation, a.isAnimateToTop));
		return d
	}, f = function(a) {
			...
			a.params = {
				...
				defaultGrid: a.$control.attr("data-default") || "list-view",
				storageStatus: null
			};
			f(a);
			return jQuery.extend(this, a)
	...
	c.prototype.getDeepLink = function() {
		var a = "",
			e;
		e = b(this, !1);
		e.data && e.data.isGrid && (a = this.name + this.options.delimiter0 + "isGrid=true");
		return a
	};
	c.prototype.getStatusByDeepLink = function(a, e) {
		var d;
		d = b(this, !0);
		d.data && "isGrid" === a && (d.data.isGrid = !0);
		return d
	};
	c.prototype.setStatus = function(a, b) {
		a.data && (this.inStorage && b && (this.params.storageStatus = a), !this.inStorage && b ? (this.$root.removeClass("jplist-grid").addClass("jplist-list"),
			a.data.isGrid = !1, this.observer.trigger(this.observer.events.statusEvent, [a])) : a.data.isGrid ? this.$root.addClass("jplist-grid").removeClass("jplist-list") : this.$root.removeClass("jplist-grid").addClass("jplist-list"))
	};
...
(function() {
	...
	b.prototype.getStatus = function(b) {
		...
		return new jQuery.fn.jplist.app.dto.StatusDTO(this.name, this.action, this.type, b, this.inStorage, this.inAnimation, this.isAnimateToTop)
	};
...
(function() {
	var b = function(a) {
		...
		b && (b.datepicker(c, d), b.datepicker(k, d))
			...
			b && f ? d = f : (m = a.$control.attr("data-path").toString(), f = a.$control.attr("data-datetime-format").toString(), l = a.$control.data("jplist-datepicker-range-prev"), h = a.$control.data("jplist-datepicker-range-next"),
				b || (d = l.datepicker("getDate"), c = h.datepicker("getDate")), d = new jQuery.fn.jplist.ui.controls.DatePickerRangeFilterDTO(m, f, d, c), d = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, d, a.inStorage, a.inAnimation, a.isAnimateToTop));
			return d
		}, c = function(a) {
			b(a);
			return jQuery.extend(this, a)
	...
	c.prototype.getDeepLink = function() {
		var a = "",
			b;
		b = f(this, !1);
		b.data && (jQuery.isNumeric(b.data.prev_year) && (jQuery.isNumeric(b.data.prev_month) && jQuery.isNumeric(b.data.prev_day)) &&
	...
	c.prototype.getStatusByDeepLink = function(a, b) {
		var d,
			c;
		d = f(this, !0);
		if (d.data) switch (a) {
	...
	c.prototype.getPaths = function(a) {
		var b;
		if (b = this.$control.attr("data-path").toString()) b = new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(b, "datetime"), a.push(b)
	};
	c.prototype.setStatus =
		function(a, b) {
			var d, c, f;
			this.inStorage && b && this.$control.data("storage-status", a);
			...
			jQuery.isNumeric(a.data.next_year) && jQuery.isNumeric(a.data.next_month) && jQuery.isNumeric(a.data.next_day) ?
				(d = new Date(a.data.next_year, a.data.next_month, a.data.next_day), f.datepicker("setDate", d)) : f.val("")
	};
...
(function() {
	...
	c.prototype.getDeepLink = function() {
		var a = "",
			e;
		e = b(this, !1);
		e.data && (jQuery.isNumeric(e.data.prev) && jQuery.isNumeric(e.data.next)) && (a = this.name + this.options.delimiter0 + "prev" + this.options.delimiter2 + "next=" + e.data.prev + this.options.delimiter2 + e.data.next);
		return a
	};
	c.prototype.getStatusByDeepLink = function(a, e) {
		var d, c;
		d = b(this, !0);
		d.data && a === "prev" + this.options.delimiter2 + "next" && (c = e.split(this.options.delimiter2), 2 === c.length && (d.data.prev = c[0], d.data.next = c[1]));
		return d
	};
	c.prototype.getPaths = function(a) {
		var b;
	...
	c.prototype.setStatus = function(a, b) {
		...
		jQuery.isNumeric(a.data.prev) && jQuery.isNumeric(a.data.next) && (d = Number(a.data.prev),
			c = Number(a.data.next), !isNaN(d) && !isNaN(c) && (this.params.$uiSlider.slider("values", 0) != d && this.params.$uiSlider.slider("values", 0, d), this.params.$uiSlider.slider("values", 1) != c && this.params.$uiSlider.slider("values", 1, c)));
...
(function() {
	...
	c.prototype.getDeepLink = function() {
		var a = "",
			c;
		c = b(this, !1);
		c.data && c.data.selected && (a = this.name + this.options.delimiter0 + "selected=true");
		return a
	};
	c.prototype.getStatusByDeepLink = function(a, c) {
		var d = null,
			f, d = b(this, !1);
		if (d.data && (f = "selected" === a && "true" === c)) d.data.selected = f, d.data.filterType =
			"path";
		return d
	};
	c.prototype.getPaths = function(a) {
...
(function() {
	var b = function(a, b) {
		var c, e = [],
			f, m, n;
		c = a.$control.data("storage-status");
		b && c || a.params.$buttons.each(function(a, d) {
			f = jQuery(d);
			if (n = b ? "true" === f.attr("data-selected") : f.data("selected") || !1)(m = f.attr("data-path")) && e.push(m)
		});
		return c = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, {
			pathGroup: e,
			filterType: "pathGroup"
		}, a.inStorage, a.inAnimation, a.isAnimateToTop)
	}, f = function(a, b) {
			var c, e;
			a.params.$buttons.each(function(a, d) {
				if (c = jQuery(d).attr("data-path")) e = new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(c,
					"text"), b.push(e)
			})
		}, c = function(a, b, c) {
			var e;
			...
			if (b.data && b.data.pathGroup && jQuery.isArray(b.data.pathGroup) && 0 < b.data.pathGroup.length)
				for (var f = 0; f < b.data.pathGroup.length; f++) c = b.data.pathGroup[f], e = a.params.$buttons.filter('[data-path="' + c + '"]'), 0 < e.length && (e.addClass("jplist-selected"), e.data("selected", !0))
		}, a = function(a) {
	...
	e.prototype.getDeepLink = function() {
		var a = "",
			...
			e;
		e = b(this, !1);
		if (e.data && e.data.pathGroup &&
			0 < e.data.pathGroup.length) {
			for (var f = 0; f < e.data.pathGroup.length; f++) a = e.data.pathGroup[f], 0 < f && (c += this.options.delimiter2), c += a;
	...
	e.prototype.getStatusByDeepLink = function(a, c) {
		var e;
		e = b(this, !1);
		e.data && "selected" === a && (e.data.pathGroup = c.split(this.options.delimiter2));
		return e
	};
...
(function() {
	...
	c.prototype.getStatusByDeepLink = function(a, c) {
		var d = null,
			f, d = b(this, !1);
		if (d.data && (f = "selected" === a && "true" === c)) d.data.selected = f, d.data.value = this.params.dataText;
		return d
	};
	c.prototype.getPaths = function(a) {
		var b;
...
(function() {
	var b = function(a, b) {
		...
		b && f ? c = f : (a.controlOptions && a.controlOptions.ignore && (c = a.controlOptions.ignore), a.params.$buttons.each(function(a, d) {
			...
			a.inAnimation, a.isAnimateToTop));
		return c
	}, f = function(a, b) {
			var c, e, f;
			a.params.$buttons.each(function(a, d) {
			...
			if (b.data && b.data.textAndPathsGroup && jQuery.isArray(b.data.textAndPathsGroup) && 0 < b.data.textAndPathsGroup.length)
				for (var f = 0; f < b.data.textAndPathsGroup.length; f++) c =
					b.data.textAndPathsGroup[f], e = a.params.$buttons.filter('[data-path="' + c.path + '"][data-text="' + c.text + '"]'), 0 < e.length && c.selected && (e.addClass("jplist-selected"), e.data("selected", !0))
		}, a = function(a) {
			var c;
			a.params.$buttons.on("click", function() {
				var e = jQuery(this);
	...
	e.prototype.getDeepLink = function() {
		var a = "",
			c, e, f = [];
		c = b(this, !1);
		if (c.data && c.data.textAndPathsGroup && 0 < c.data.textAndPathsGroup.length) {
			for (var h = 0; h < c.data.textAndPathsGroup.length; h++) e = c.data.textAndPathsGroup[h], e.selected && f.push(e.text +
				this.options.delimiter3 + e.path);
...
(function() {
	var b = function(a, b) {
		...
		if (!b || !c) a.params.$checkboxes.each(function(a, c) {
			...
			d = d.attr("data-path");
			f && d && e.push(d)
		}), c = new jQuery.fn.jplist.ui.controls.CheckboxGroupFilterDTO(e), c = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, c, a.inStorage, a.inAnimation, a.isAnimateToTop);
		return c
	}, f = function(a, b) {
			a.params.$checkboxes.each(function(a, c) {
				var d;
				if (d = jQuery(this).attr("data-path")) d =
					new jQuery.fn.jplist.domain.dom.models.DataItemMemberPathModel(d, "text"), b.push(d)
			})
		}, c = function(a, b, c) {
			var e;
			...
			if (b.data && b.data.pathGroup && jQuery.isArray(b.data.pathGroup) && 0 < b.data.pathGroup.length)
				for (var f = 0; f < b.data.pathGroup.length; f++) c = b.data.pathGroup[f], e = a.params.$checkboxes.filter('[data-path="' + c + '"]'), 0 < e.length && (e.addClass("jplist-selected"), e.get(0).checked = !0)
		}, a = function(a) {
			a.params.$checkboxes.on("change",
				function() {
					a.history.addStatus(b(a, !1));
					a.observer.trigger(a.observer.events.forceRenderStatusesEvent, [!1])
				})
	...
	e.prototype.getDeepLink = function() {
		var a = "",
			c, e = "";
		c = b(this, !1);
		if (c.data && jQuery.isArray(c.data.pathGroup) &&
	...
	e.prototype.getStatusByDeepLink = function(a, c) {
		var e, f;
		e = b(this, !0);
		e.data && "pathGroup" === a && (f = c.split(this.options.delimiter2), 0 < f.length && (e.data.pathGroup = f));
		return e
	};
	e.prototype.getPaths = function(a) {
		f(this, a)
...
(function() {
	var b = function(a, b) {
		...
		if (!b || !c) a.params.$checkboxes.each(function(a, c) {
			...
			(e = e.val()) && l && f.push(e)
		}), c = new jQuery.fn.jplist.ui.controls.CheckboxTextFilterDTO(f, a.params.dataLogic, a.params.dataPath, a.params.ignore), c = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, c, a.inStorage, a.inAnimation, a.isAnimateToTop);
		return c
	}, f = function(a, b, c) {
			var f;
	...
	a.prototype.getDeepLink = function() {
		var a =
			...
			c, f = "";
		c = b(this, !1);
		if (c.data && jQuery.isArray(c.data.textGroup) && 0 < c.data.textGroup.length) {
	...
	a.prototype.getStatusByDeepLink = function(a, c) {
		var f = null,
			k, f = b(this, !0);
		f.data && "textGroup" === a && (k = c.split(this.options.delimiter2), 0 < k.length && (f.data.textGroup = k));
		return f
	};
	a.prototype.getPaths = function(a) {
		var b;
...
(function() {
	var b = function(a, b) {
		...
		if (!b || !c) f = b ? a.params.initialSelected || !1 : a.$control.get(0).checked, c = {
			...
			filterType: "path",
			selected: f
		}, f || (c.filterType = ""), c = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, c, a.inStorage, a.inAnimation, a.isAnimateToTop);
		return c
	}, f = function(a) {
	...
	c.prototype.getStatusByDeepLink = function(a, c) {
		var d;
		d = b(this, !0);
		d.data && "selected" === a && (d.data.selected = !0);
		return d
	};
	c.prototype.getPaths = function(a) {
		var b;
...
(function() {
	var b = function(a, b) {
		...
		b && c ? f = c : (c = b ? "true" === a.$control.attr("data-selected") : a.params.selected, a.params.path && (f = c ? {
			...
			filterType: "",
			selected: c
		}, f = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, f, a.inStorage, a.inAnimation, a.isAnimateToTop)));
		return f
	}, f = function(a) {
			a.$control.on("click", function() {
				a.params.selected = !a.params.selected;
	...
	c.prototype.getDeepLink = function() {
		var a = "",
			c;
		c = b(this, !1);
		c.data && c.data.selected && (a = this.name + this.options.delimiter0 +
			"selected=true");
		return a
	};
	c.prototype.getStatusByDeepLink = function(a, c) {
		var d = null,
			d = b(this, !1);
		d.data && ("selected" === a && "true" === c) && (d.data = {
