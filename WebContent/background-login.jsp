...
<html>
 <head> 
  <title>后台登录 &middot; 搜赛网</title> 
  <meta name="viewport" content="width=device-width, initial-scale=1.0" /> 
  <meta name="description" content="搜赛网后台登录页面" /> 
 ...
 <body class="login"> 
  <div class="container"> 
   <div class="row"> 
    <div class="span5 offset2"> 
     ...
     <span class="logotext">管理员登录</span> 
    </div> 
   </div> 
   <div class="row bd"> 
    ...
    <div class="span3 offset2 form-signin"> 
     <form id="formlogin" action="processLogin" method="post"> 
      <fieldset> 
       ...
       <label class="checkbox hide"><input type="checkbox" value="remember-me" />记住我</label> 
  ...
  function getCookie(name){
    ...
    $("#signinBtn").click(function(){
      if($("input[value='remember-me']").is(":checked")){
        ...
        var userName = $("#inputUsername").val();
          setCookie("sousaiAdminName",userName);
          console.log("set cookie yet and then submit:"+ getCookie("sousaiAdminName"));
          $("#signinBtn").submit();
      }else {
        //若没有勾选 记住我，则直接提交
        $("#signinBtn").submit();
    ...
    //进入此页面查找已存在的cookie
    if(getCookie("sousaiAdminName") != null){
      $("#inputUsername").val(unescape(getCookie("sousaiAdminName")));
    $("input[value='remember-me']").attr("checked","checked");
  }else {
    console.log(getCookie("sousaiAdminName"));
    $("#inputUsername").val("");
  }
});
